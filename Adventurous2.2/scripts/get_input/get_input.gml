...
Block  = mouse_check_button(mb_right)         || (gamepad_button_check(0,gp_face2)) || keyboard_check_direct(vk_alt)||  keyboard_check(ord("K"))  ;
Jump   = keyboard_check_pressed(vk_space)     || (gamepad_button_check_pressed(0,gp_face1)) ||  keyboard_check(ord("W"))     ;
...
Attack = mouse_check_button_pressed(mb_left)  || (gamepad_button_check_pressed(0,gp_shoulderrb)) || keyboard_check_pressed(vk_control) ||  keyboard_check(ord("J"));
