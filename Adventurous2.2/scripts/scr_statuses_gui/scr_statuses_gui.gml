...
if (Fired > 0){
	draw_sprite_ext(spr_statuses, 2, x, y-74, image_xscale, image_yscale, image_angle, image_blend, image_alpha);
...
if (Poisoned >0){
	draw_sprite_ext(spr_statuses, 0, x-16, y-74, image_xscale, image_yscale, image_angle, image_blend, image_alpha);
	/// draw the GUI
